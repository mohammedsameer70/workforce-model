package com.boostphysioclinic.workforceapplication.config;

import com.boostphysioclinic.workforceapplication.Repository.UserRepository;
import com.boostphysioclinic.workforceapplication.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/train/**").hasAnyRole("ADMIN", "MANAGER")
                .requestMatchers("/api/ai-models/**").hasAnyRole("ADMIN", "MANAGER")
                .requestMatchers("/api/settings/**").permitAll()
                .requestMatchers("/api/monitoring/**").hasRole("ADMIN")
                .requestMatchers("/api/employees/**").hasAnyRole("ADMIN", "MANAGER", "VIEWER")
